 ...
 * 游戏场景
 */
var GameSceneMain = (function(_super){

    function GameSceneMain(){
        // GameScene.super(this);
        this.Init();
    }
    Laya.class(GameSceneMain,"GameSceneMain",_super);
    _proto = GameSceneMain.prototype;
    //常量
    var RANDOMEMINEMIN = 4;                                                //随机产生雷的最小值
    var RANDOMMINEMAX = 10;                                                 //随机尝试雷的最大值+最小值
    ...
    /**生成方块 */
    _proto.createSquareMapList = function(){
    ...
    /**更新地雷状态 */
    _proto.updateMineListFun = function(){
        var clickMine = 0;
        for (var i = 0; i < this.m_listMine.length; i++) {
            var mineTemp = this.m_listMine[i];
