...
var FBGame = (function (_super) {
    ...
    _proto.loadRewardAd = function(){
        ...
        FBInstant.getRewardedVideoAsync('336634453592976_336637940259294').then(function(rewardedVideo) {
    ...
    _proto.loadInterstitialAd = function(){
        ...
        //插屏
        FBInstant.getInterstitialAdAsync('336634453592976_336637803592641').then(function(interstitial) {
    ...
    _proto.getImgBase64 = function(){
        ...
        shareSp.loadImage("WXGameUI/shard.png");
