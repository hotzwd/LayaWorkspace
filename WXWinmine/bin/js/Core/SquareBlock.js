 ...
 * 方块
 */
var SquareBlock = (function(_super){

    function SquareBlock(){
        SquareBlock.super(this);
        this.onInit();
    }
    Laya.class(SquareBlock,"SquareBlock",_super);
    _proto = SquareBlock.prototype;
    ...
    _proto.onInit = function(){
        ...
        this.icon = new Laya.Image("WXGameUI/img_shikuai"+shikuaiNum+".png");
    ...
    _proto.UpdateEffect = function(){
        ...
        if(this.type == SquareTypes.NoClick){
            if(this.aroundMineNum == 0){
                ...
                this.icon.skin = "WXGameUI/img_zhouweileishu-"+this.aroundMineNum+".png";
            }
        }
        if(this.type == SquareTypes.Mine){
