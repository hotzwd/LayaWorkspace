...
function beginLoad(){
	...
	var arr = [
                //图集
                ["res/atlas/comp.atlas",Laya.Loader.ATLAS],
				["res/images_1.json",Laya.Loader.JSON],
				["res/images_2.json",Laya.Loader.JSON],
				["res/images_3.json",Laya.Loader.JSON],
                ["res/images_4.json",Laya.Loader.JSON],
    ...
    Laya.loader.load(asset,Laya.Handler.create(this,onLoaded));
}
