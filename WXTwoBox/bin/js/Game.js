...
Laya.stage.bgColor = "#3f0047";//设置画布的背景颜色。
...
function beginLoadbengbeng() {
     var arr = [
                ...
                // //图片
                ["Game/bggame-sheet0.png",Laya.Loader.IMAGE],
                ["Game/menutitulo-sheet0.png",Laya.Loader.IMAGE],
                ["Game/piso-sheet0.png",Laya.Loader.IMAGE],
                // //字体
    ...
    Laya.loader.load(asset, Laya.Handler.create(this, bengbengloadingCallback), null);
}

function bengbengloadingCallback() {
