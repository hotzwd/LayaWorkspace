function AVK_GAME(y, ea, fa) {
	...
	function ca(b, f, k, e, d, h) {
		...
		this.make_copy = function() {
			...
			a.EL = this.EL;
			a.ID = this.ID + 1;
			return new ca(c[0], c[1], c[2], c[3], c[4],
				c[5])
		};
		this.animations = h;
		this.uni_width = e;
		...
		this.update = function(a) {
			l -= a;
			0 >= l && (l = this.time / animations, m++, m >= animations && (m =
				0), this.sprite.gotoAndStop(m))
		};
		this.set_parent = function(b) {
			b.sprite.addChild(this.sprite);
			b = this.sprite;
	...
	function d(b, f, k, e, g, h) {
		...
		this.sprite.click = this.sprite.tap = function(a) {
			c.enabled && (null == c.down_sprite ? (c.sprite.scale.x = 1, c.sprite.scale.y =
				1, c.sprite.position.x = c.sprite.owner.up_x, c.sprite.position.y = c.sprite.owner.up_y) : (c.sprite.visible = !0, c.down_sprite.visible = !1), N("click", c.sprite.owner.WND, c.sprite.owner.EL, c.sprite.owner.ID), a.originalEvent.stopPropagation(), a.originalEvent.preventDefault())
		};
		this.sprite.mouseup = this.sprite.touchend = this.sprite.mouseupoutside = this.sprite.touchendoutside = function(a) {
			c.enabled && (null == c.down_sprite ? (c.sprite.scale.x = 1, c.sprite.scale.y = 1, c.sprite.position.x = c.sprite.owner.up_x, c.sprite.position.y =
				c.sprite.owner.up_y) : (c.sprite.visible = !0, c.down_sprite.visible = !1), N("up", c.sprite.owner.WND, c.sprite.owner.EL, c.sprite.owner.ID), a.originalEvent.stopPropagation(), a.originalEvent.preventDefault())
		};
		a.GUI.addChild(this.sprite);
		this.update = function(a) {
			p -= a;
		...
		this.set_parent = function(b) {
			...
			b = c.sprite;
			for (var e = 0, f = 0; b = b.parent;) b != a.GUI &&
				(e += b.position.x, f += b.position.y);
		...
		this.center = function() {
			...
			for (var a = 0; a < c.sprite.children.length; a++) c.sprite.children[a].position.x -=
				.5 * c.uni_width, c.sprite.children[a].position.y -= .5 * c.uni_height;
			c.refresh()
		};
		this.refresh()
	}
	...
	function da(b, f, d, e, g, h) {
		...
		var q = 0,
			r = 0;
		if ("" == b) this.sprite = new PIXI.DisplayObjectContainer,
			this.sprite.position.x = f, this.sprite.position.y = d;
		else if (1 == h) this.sprite = PIXI.Sprite.fromFrame(b), this.sprite.position.x = f, this.sprite.position.y = d;
		else {
			e = [];
			for (g = 0; g < h; g++) {
		...
		this.set_progress = function(a) {
			...
			switch (l) {
				...
				case "u":
					...
					break;
				case "d":
					this.sprite.scale.x = 1, this.sprite.scale.y = a, this.sprite.position.x = this.old_x, this.sprite.position.y =
						this.old_y + this.uni_height * (1 - a)
			}
		};
	...
	function T() {
		...
		a.EL = "btn_start";
		this.btn_start = new d("intro_btn_start",
			251, 808, 140, 144, 1);
	...
	function X() {
		...
		a.EL = "no_snd_btn";
		this.no_snd_btn =
			new b("credits_no_snd_btn", 554, 261, 70, 72, 1);
		this.sprite.addChild(this.no_snd_btn.sprite);
		a.EL = "snd_btn";
	...
	function Y() {
		...
		a.EL = "btn_more";
		this.btn_more = new d("main_btn_more",
			295, 729, 89, 92, 1);
	...
	function Z() {
		...
		a.EL = "close_btn";
		this.close_btn =
			new b("game_close_btn", 481, 263, 70, 71, 1);
		...
		this.btn_edit_chain_right = new d("game_btn_edit_chain_right",
			579, 941, 61, 62, 1);
		...
		a.EL = "compl";
		this.compl = new b("game_compl", 42, 195,
			556, 758, 1);
		...
		this.sprite.addChild(this.more_btn.sprite);
		a.EL = "btn_more";
		this.btn_more = new d("game_btn_more",
			127, 741, 89, 92, 1);
		this.sprite.addChild(this.btn_more.sprite);
		a.EL = "next_btn_win";
	...
	function O(d, f, k, e, g, h) {
		...
		a.EL = "path_1_3";
		this.path_1_3 = new b("game_path_1_3",
			65, 58, 105, 40, 1);
	...
	function $() {
		...
		this.sprite.visible = !1;
		a.EL = "back";
		this.back = new b("levels_back", 0, 800,
			637, 338, 1);
		this.sprite.addChild(this.back.sprite);
		a.EL = "back_second";
		...
		a.EL = "lev_btn_10";
		this.lev_btn_10 =
			new b("levels_lev_btn_10", 503, 446, 86, 88, 1);
		...
		a.EL = "lev_btn_6";
		this.lev_btn_6 = new b("levels_lev_btn_6", 54,
			446, 86, 88, 1);
		...
		a.EL = "btn_lev_17";
		this.btn_lev_17 =
			new d("levels_btn_lev_17", 170, 647, 78, 80, 1);
		...
		a.EL = "btn_lev_13";
		this.btn_lev_13 = new d("levels_btn_lev_13",
			283, 548, 78, 80, 1);
		...
		a.EL = "zz_1_1";
		this.zz_1_1 = new b("levels_zz_1_1",
			67, 407, 11, 10, 1);
		...
		a.EL = "zz_2_3";
		this.zz_2_3 =
			new b("levels_zz_2_3", 223, 407, 11, 10, 1);
		...
		a.EL = "zz_12_2";
		this.zz_12_2 = new b("levels_zz_12_2", 201, 603, 11, 10,
			1);
		...
		a.EL = "zz_14_1";
		this.zz_14_1 =
			new b("levels_zz_14_1", 403, 603, 11, 10, 1);
		...
		a.EL = "zz_17_1";
		this.zz_17_1 = new b("levels_zz_17_1", 179, 702, 11, 10,
			1);
		...
		a.EL = "zz_18_3";
		this.zz_18_3 =
			new b("levels_zz_18_3", 336, 702, 11, 10, 1);
		...
		a.EL = "lock_18";
		this.lock_18 = new b("levels_lock_18", 283, 647, 78,
			80, 1);
		...
		this.sprite.addChild(this.close_btn.sprite);
		a.EL = "btn_close";
		this.btn_close = new d("levels_btn_close",
			268, 743, 111, 114, 1);
		this.sprite.addChild(this.btn_close.sprite);
		a.EL = "btn_add";
	...
	function P(b, f, k, e, g, h) {
		...
		this.set_parent = function(b) {
			b.sprite.addChild(this.sprite);
			b = this.sprite;
			for (var c = 0, e = 0; b = b.parent;) b != a.GUI &&
				(c += b.position.x, e += b.position.y);
			this.sprite.position.x -= c;
			this.sprite.position.y -= e
		}
	}
	...
	function aa() {
		...
		a.EL = "bl_001_0";
		this.bl_001_0 =
			new b("blocks_bl_001_0", 1, -20, 423, 208, 1);
		...
		a.EL = "bl_006_1";
		this.bl_006_1 = new b("blocks_bl_006_1",
			0, -16, 212, 204, 1);
	...
	var n, ia = ea,
		...
		N = fa,
		a = this,
		J = "data/images_1.json data/images_2.json data/images_3.json data/images_4.json data/fonts/main_font.xml data/fonts/small_font.xml".split(" "),
		B = ["公主被劫了...", "Shuffling the field...", "勇士快上!!", "Feeding the horse..."],
		s = 0,
		w = 0,
		r = new PIXI.Text("", {
	...
	this.RENDER.view.style["z-index"] =
		"1";
	...
	this.TOO_SLOW = !1;
	y = new PIXI.AssetLoader(["data/pics/main.jpg", "data/pics/up.png", "data/pics/upper.png"]);
	var x = 0;
	y.onComplete = function() {
		Q.load();
		var b = PIXI.Sprite.fromFrame("data/pics/main.jpg");
		x = PIXI.Sprite.fromFrame("data/pics/up.png");
		var f = PIXI.Sprite.fromFrame("data/pics/upper.png");
	...
	this.init_captions = function() {
		for (var b, f = 0; f < a.DATA.gui.length; f++) {
			if (b = !a[a.DATA.gui[f].id].sprite.visible) a.GUI.removeChild(a[a.DATA.gui[f].id].sprite), a.TMP_SPR.addChildAt(a[a.DATA.gui[f].id].sprite,
				0);
	...
	this.filtered = function(b, f, d, e, g) {
		for (var h = 0, c = 0; c < a.DATA[b].length; c++)
			if (a.DATA[b][c][e] ==
				g) {
	...
	this.find = function(b, d, k) {
		for (var e = 0; e < a.DATA[b].length; e++)
			if (a.DATA[b][e][d] == k) return e;
		return -1
	};
	this.ACT = new function() {
		...
		this.start = function(a, e, g) {
			if (b && b[a]) {
				for (var h = -1, c = 0; c < d.length54; c++)
					if (0 >= d[5 * c + 3]) {
						h = 5 * c;
						break
					}
		...
		this.update = function(a) {
			for (var e = 0; e < d.length / 5; e++)
				if (0 < d[5 * e + 3])
					if (0 < d[5 * e + 2]) d[5 * e + 2] -= a, 0 >= d[5 * e + 2] && (d[5 * e + 3] += d[5 * e + 2], d[5 * e + 2] = 0);
					else {
						d[5 * e + 3] -= a;
						0 >= d[5 * e + 3] && (d[5 *
							e + 3] = 0);
